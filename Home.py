...
with st.expander("App Limitations "):
    st.write("The more data, the less the limitations. The more infomrmation we provide this application, the better it will get at forecasting.")
...
with st.expander("**Premium Model**"):
    st.write("""
            Welcome to the Season 7 Premium Model - Hornets Venom GT! If you have any questions at all, feel free to cnotact a member of our team.""")
